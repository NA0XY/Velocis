...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    ...
    const turbulentUniforms = {
      uFreq: { value: new THREE.Vector4(3, 3, 3, 3) }, // More rhythmic waves
      uAmp: { value: new THREE.Vector4(35, 10, 10, 10) } // Higher amplitude
    };
  ...
  return <div ref={hyperspeed} style={{ width: '100%', height: '100%', minHeight: '300px', position: 'relative' }}></div>;
};
